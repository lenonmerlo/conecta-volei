...
(function runTest() {
  ...
  const membersWaitlist = [
    {
      ...
      type: "member",
      slot: "waitlist",
      registered_at: new Date(lastThursday.getTime() + 10 * 60 * 1000).toISOString(),
    },
    {
      id: "m2",
      name: "Membro 2",
      type: "member",
      slot: "waitlist",
      registered_at: new Date(lastThursday.getTime() + 20 * 60 * 1000).toISOString(),
    },
    {
      id: "m3",
      name: "Membro 3",
      type: "member",
      slot: "waitlist",
      registered_at: new Date(lastThursday.getTime() + 30 * 60 * 1000).toISOString(),
    },
  ];
  ...
  const guests = [
    {
      ...
      type: "guest",
      slot: "guests",
      registered_at: new Date(lastThursday.getTime() + 2 * 60 * 1000).toISOString(),
    },
    {
      id: "g2",
      name: "Convidado 2",
      type: "guest",
      slot: "guests",
      registered_at: new Date(lastThursday.getTime() + 5 * 60 * 1000).toISOString(),
    },
  ];
  ...
  assert(
    firstThreeAreMembers,
    "Falha: os membros nao ficaram na frente dos convidados apos a migracao.",
  );
  assert(
    lastTwoAreGuests,
    "Falha: os convidados nao ficaram no final da waitlist apos a migracao.",
  );
